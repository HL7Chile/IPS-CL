...
Description: "Este perfil representa las restricciones aplicadas al recurso Dispositivo por la Guía de implementación de FHIR del Resumen internacional de pacientes (IPS), basada en el estándar FHIR R4.;
