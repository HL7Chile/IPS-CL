...
* code from $medication-snomed-absent-unknown-uv-ips (preferred)
...
* code ^binding.extension[=].extension[=].valueMarkdown = "Términos de medicación SNOMED disponibles en IPS Free Set"
...
* code ^binding.extension[=].extension[+].url = "documentation"
* code ^binding.extension[=].extension[=].valueMarkdown = "Códigos de medicación ausente o desconocida"
* code ^binding.extension[=].url = "http://hl7.org/fhir/tools/StructureDefinition/additional-binding"
* code ^binding.extension[+].extension[0].url = "purpose"
* code ^binding.extension[=].extension[=].valueCode = #candidate
* code ^binding.extension[=].extension[+].url = "valueSet"
...
* form only $CodeableConcept-uv-ips
* form MS
* form from $medicine-doseform (preferred)
  * ^short = "Describe la forma del producto: Polvo, cápsula, comprimido, etc."
* ingredient MS
* ingredient.item[x] only $CodeableConcept-uv-ips or Reference(Substance or Medication)
* ingredient.item[x] MS
* ingredient.item[x] from $medicine-active-substances-uv-ips (preferred)
...
* ingredient.strength only $Ratio-uv-ips
