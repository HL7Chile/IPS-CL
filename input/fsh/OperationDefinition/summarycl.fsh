...
Usage: #definition
Title: "Operación $summary: Resumen Clinico de Chile"
Description: """
...
El servidor **DEBE** permitir el uso del perfil del [Documento](StructureDefinition-Composition-cl-ips.html).
...
* parameter[+]
  ...
  * min = 0
  * max = "1"
  * documentation = "El Bundle devuelto es un documento que cumple con el parámetro del perfil de Composición [Documento  ](StructureDefinition-Composition-cl-ips.html)."
  * type = #Bundle
