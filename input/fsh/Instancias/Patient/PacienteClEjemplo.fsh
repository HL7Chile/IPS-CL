...
* address.city.extension[0].valueCodeableConcept.coding.display = "Santiago"
...
* address.state.extension[0].valueCodeableConcept.coding.display = "Región Metropolitana"
